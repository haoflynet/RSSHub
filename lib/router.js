...
// 外包
router.get('/waibao/coding/newest', require('./routes/waibao/coding'));
router.get('/waibao/clouderwork/newest', require('./routes/waibao/clouderwork'));
router.get('/waibao/shixian/newest', require('./routes/waibao/shixian'));
router.get('/waibao/yuanchengwork/newest', require('./routes/waibao/yuanchengwork'));
router.get('/waibao/freelancer/newest/:type', require('./routes/waibao/freelancer'));
router.get('/waibao/jfh/newest', require('./routes/waibao/jfh'));
router.get('/waibao/oschina/newest', require('./routes/waibao/oschina'));
